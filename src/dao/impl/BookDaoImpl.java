...
public class BookDaoImpl implements BookDao {
	...
	public void add(Book book) {
		try {
			...
			Object params[] = { book.getId(), book.getName(), book.getAuthor(), book.getPrice(), book.getImage(),
	...
	public void update(Book book) {
		try {
			...
			Object params[] = { book.getName(), book.getAuthor(), book.getPrice(), book.getImage(),
					book.getDescription(), book.getCategory_id(), book.getId() };
			runner.update(sql, params);
		} catch (SQLException e) {
			e.printStackTrace();
			throw new RuntimeException(e);
